class exagramme {
    constructor(params) {
        ...
        this.fctClickExa = params.fctClickExa ? params.fctClickExa : false;
        this.fctClickTrait = params.fctClickTrait ? params.fctClickTrait : false;
        this.colorfond = params.color ? params.color : 'white';
        this.colorTrait = params.color ? params.color : 'black';
        this.colorVieuxYin = params.color ? params.color : 'black';
        this.colorVieuxYang = params.color ? params.color : 'white';
        ...
        var svg, global
            ...
            , yTrait = d3.scaleBand().paddingInner(0.2).paddingOuter(0.3).align(0.5)
		          .range([0, haut])
		          .domain([0, 1, 2, 3, 4, 5])
            , aleaTrait = d3.randomInt(0, 4)
            , traits = ['yin', 'yang', 'vieux-yin', 'vieux-yang'], curTraits = [];            

        this.init = function () {
            
            svg = this.cont.append("svg")
                .attr("id", me.idCont+'svgExa')
